  ...
  return (
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
        <div className='px-2 flex justify-between items-center w-full h-full'>
            <div className='flex items-center'>
                ...
                <ul className='hidden md:flex cursor-pointer'>
                    ...
                    <li><Link to='about' smooth={true} offset={-200} duration={500}>Nosotros</Link></li>
            ...
            <div className='hidden md:flex pr-4'>
                <button className='border-none bg-transparent text-black mr-4'>Registrarse</button>
                <button className='px-8 py-3'>Iniciar sesión</button>
            </div>
        ...
        <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8 cursor-pointer'}>
            ...
            <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to='about' smooth={true} offset={-200} duration={500}>Nosotros</Link></li>
            ...
            <div className='flex flex-col my-4'>
                <button className='bg-transparent text-indigo-600 px-8 py-3 mb-4'>Rgistrarse</button>
                <button className='px-8 py-3'>Iniciar sesión</button>
            </div>
        </ul>
    </div>
